...
public class Instancia {
    ...
    private void montaSalas() {
        ...
        sala1.setCodigoSala("s1");
        sala2.setCodigoSala("s2");
        sala3.setCodigoSala("s3");
        sala4.setCodigoSala("s4");
        sala5.setCodigoSala("s5");

        sala1.setMaxAlunos(33);
        sala2.setMaxAlunos(34);
        sala3.setMaxAlunos(35);
        sala4.setMaxAlunos(29);
        sala5.setMaxAlunos(45);
    ...
    private void montaProfessores() {
        ...
        professor1.setNome("João Adalberto");
        professor2.setNome("Maria Cristina");
        professor3.setNome("Rosely da Sulva");
        professor4.setNome("Marcelo Cristian");
        professor5.setNome("Mathias da Cruz");
        professor6.setNome("Filipe de Campos");
        professor7.setNome("Rafaela do Nascimento");
        ...
        professor2.setSalario("1300");
        professor3.setSalario("1400");
        professor4.setSalario("1000");
